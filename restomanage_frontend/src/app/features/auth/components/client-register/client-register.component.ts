...
import { clientRegister } from '../../../../store/auth/auth.actions';
...
@Component({
  ...
  template: `
    <div class="text-center mb-8">
      <h2 class="text-3xl font-bold text-gray-900">Create Client Account</h2>
      <p class="mt-2 text-gray-600">Register to start ordering meals</p>
    </div>
...
export class ClientRegisterComponent implements OnInit {
  ...
  onSubmit() {
    if (this.registerForm.valid) {
      this.store.dispatch(clientRegister({ data: this.registerForm.value }));
    } else {
